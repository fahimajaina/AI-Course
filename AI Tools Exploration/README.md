...
- **Presentation Slides**: `Exploring-Artificial-Intelligence-Theory-Meets-Practice.pptx` (10-12 slides)
- **Course Summary Video**: `My Journey Through AI Theory & Lab.mp4` (1+ minute duration)
- **Google Drive Link**: [Access All Files](https://drive.google.com/drive/folders/1nKV2BcBXuiHgC8Xfq5Jz6m2R-QnyW_SR?usp=drive_link)
...
3. **Content Input**
   ...
   - Entered the prompt: "Create a presentation about my Artificial Intelligence course covering both theoretical concepts and practical implementations"
...
6. **Export**
   ...
   - Saved as "Exploring-Artificial-Intelligence-Theory-Meets-Practice.pptx"
...
6. **Final Production**
   ...
   - Saved as "My Journey Through AI Theory & Lab.mp4"

### Blog Links Followed:

- [InVideo AI Video Generator Tutorial](https://www.youtube.com/watch?v=4g6sOMaOQP8)